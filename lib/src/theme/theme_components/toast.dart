...
@immutable
class BaconToastTheme {
  const BaconToastTheme({
    this.merge = true,
  ...
  static BaconToastTheme lerp(
    ...
    return BaconToastTheme(
      ...
      closeIconPosition:
          Position.lerp(a.closeIconPosition, b.closeIconPosition, t),
      constraints: b.constraints,
    );
  }

  BaconToastTheme copyWith({
    bool? merge,
  ...
  BaconToastTheme mergeWith(BaconToastTheme? other) {
  ...
  bool operator ==(Object other) {
    ...
    return other is BaconToastTheme &&
        other.merge == merge &&
