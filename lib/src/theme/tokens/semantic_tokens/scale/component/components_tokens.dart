...
@immutable
class HiveComponentsScaleTokens
    extends ThemeExtension<HiveComponentsScaleTokens>
  ...
  const HiveComponentsScaleTokens({
    required this.x7s,
    required this.x6s,
    required this.x5s,
    required this.x4s,
  ...
  @override
  HiveComponentsScaleTokens copyWith({
    double? x7s,
    double? x6s,
    double? x5s,
    double? x4s,
    ...
    return HiveComponentsScaleTokens(
      x7s: x7s ?? this.x7s,
      x6s: x6s ?? this.x6s,
      x5s: x5s ?? this.x5s,
      x4s: x4s ?? this.x4s,
  ...
  @override
  HiveComponentsScaleTokens lerp(
      ThemeExtension<HiveComponentsScaleTokens>? other, double t) {
    if (other is! HiveComponentsScaleTokens) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', "HiveComponentsScaleTokens"));
