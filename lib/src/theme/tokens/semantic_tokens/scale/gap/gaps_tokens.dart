...
@immutable
class HiveGapTokens extends ThemeExtension<HiveGapTokens>
  ...
  @override
  HiveGapTokens lerp(ThemeExtension<HiveGapTokens>? other, double t) {
    if (other is! HiveGapTokens) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', "HiveGapTokens"));
