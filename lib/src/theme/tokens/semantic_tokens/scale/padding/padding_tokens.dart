...
@immutable
class HivePaddingTokens extends ThemeExtension<HivePaddingTokens>
  ...
  @override
  HivePaddingTokens lerp(ThemeExtension<HivePaddingTokens>? other, double t) {
    if (other is! HivePaddingTokens) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', "HivePaddingTokens"));
