...
class BaconBasePrimitiveFontSizes
    extends ThemeExtension<BaconBasePrimitiveFontSizes>
  ...
  const BaconBasePrimitiveFontSizes({
  ...
  @override
  BaconBasePrimitiveFontSizes copyWith({
    double? fontSize12,
    double? fontSize14,
    double? fontSize16,
    double? fontSize18,
    ...
    return BaconBasePrimitiveFontSizes(
  ...
  @override
  BaconBasePrimitiveFontSizes lerp(
      covariant ThemeExtension<BaconBasePrimitiveFontSizes>? other, double t) {
    if (other is! BaconBasePrimitiveFontSizes) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty("type", "BaconBasePrimitiveFontSizes"));
