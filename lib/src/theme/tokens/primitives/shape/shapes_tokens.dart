...
@immutable
class HivePrimitiveShapesTokens
    extends ThemeExtension<HivePrimitiveShapesTokens>
  ...
  const HivePrimitiveShapesTokens({
  ...
  @override
  HivePrimitiveShapesTokens copyWith({
    double? shape0,
    double? shape2,
    double? shape4,
    double? shape6,
    ...
    return HivePrimitiveShapesTokens(
  ...
  @override
  HivePrimitiveShapesTokens lerp(
      ThemeExtension<HivePrimitiveShapesTokens>? other, double t) {
    if (other is! HivePrimitiveShapesTokens) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', "HivePrimitiveShapesTokens"));
