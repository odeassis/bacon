...
@immutable
class HivePrimitiveSpacesTokens
    extends ThemeExtension<HivePrimitiveSpacesTokens>
  ...
  const HivePrimitiveSpacesTokens({
  ...
  @override
  HivePrimitiveSpacesTokens copyWith({
    double? space0,
    double? space2,
    double? space4,
    double? space6,
    ...
    return HivePrimitiveSpacesTokens(
  ...
  @override
  HivePrimitiveSpacesTokens lerp(
      ThemeExtension<HivePrimitiveSpacesTokens>? other, double t) {
    if (other is! HivePrimitiveSpacesTokens) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', "HivePrimitiveSpacesTokens"));
