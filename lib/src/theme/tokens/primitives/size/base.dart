...
@immutable
class BaconBasePrimitiveSize extends ThemeExtension<BaconBasePrimitiveSize>
  ...
  @override
  BaconBasePrimitiveSize copyWith({
    double? size0,
    double? size2,
    double? size4,
    double? size6,
  ...
  @override
  BaconBasePrimitiveSize lerp(
      ThemeExtension<BaconBasePrimitiveSize>? other, double t) {
    if (other is! BaconBasePrimitiveSize) return this;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', "BaconBasePrimitiveSize"));
