...
class BaconDefaultIconScale extends BaconBaseScale {
  const BaconDefaultIconScale({
    required super.xxxs,
    required super.xxs,
    required super.xs,
    required super.sm,
  ...
  const BaconDefaultIconScale.defaultScale()
      : super(
  ...
  const BaconDefaultIconScale.compactScale()
      : super(
  ...
  const BaconDefaultIconScale.expandedScale()
      : super(
