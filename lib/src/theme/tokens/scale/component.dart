...
class BaconDefaultComponentScale extends BaconBaseScale {
  const BaconDefaultComponentScale({
    required super.xxxs,
    required super.xxs,
    required super.xs,
    required super.sm,
  ...
  const BaconDefaultComponentScale.compactScale()
      : super(
  ...
  const BaconDefaultComponentScale.expandedScale()
      : super(
