    ...
    if (!animation.isDismissed) {
      ...
      canvas.drawRRect(
        RRect.fromRectAndCorners(
          ...
          topLeft: HiveSquircleRadius(cornerRadius: topLeftLerp),
          topRight: HiveSquircleRadius(cornerRadius: topRightLerp),
          bottomLeft: HiveSquircleRadius(cornerRadius: bottomLeftLerp),
          bottomRight: HiveSquircleRadius(cornerRadius: bottomRightLerp),
        ),
        paint,
      );
    }
