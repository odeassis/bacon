...
class PulseEffectPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    if (!animation.isDismissed) {
      ...
      final double topLeftLerp = lerpDouble(borderRadius.topLeft.x,
          borderRadius.topLeft.x + resolvedExtent, rangeValue)!;
      final double topRightLerp = lerpDouble(borderRadius.topRight.x,
          borderRadius.topRight.x + resolvedExtent, rangeValue)!;
      final double bottomLeftLerp = lerpDouble(borderRadius.bottomLeft.x,
          borderRadius.bottomLeft.x + resolvedExtent, rangeValue)!;
      final double bottomRightLerp = lerpDouble(borderRadius.bottomRight.x,
          borderRadius.bottomRight.x + resolvedExtent, rangeValue)!;
      ...
      canvas.drawRRect(
        RRect.fromRectAndCorners(
          ...
          topLeft: BaconSquircleRadius(cornerRadius: topLeftLerp),
          topRight: BaconSquircleRadius(cornerRadius: topRightLerp),
          bottomLeft: BaconSquircleRadius(cornerRadius: bottomLeftLerp),
          bottomRight: BaconSquircleRadius(cornerRadius: bottomRightLerp),
        ),
        paint,
      );
    }
