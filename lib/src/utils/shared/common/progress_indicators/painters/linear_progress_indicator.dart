...
class BaconLinearProgressIndicatorPainter extends CustomPainter {
  ...
  const BaconLinearProgressIndicatorPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final containerRect = RRect.fromRectAndCorners(
      Offset.zero & size,
      topLeft: BaconSquircleRadius(cornerRadius: containerRadius.topLeft.x),
      topRight: BaconSquircleRadius(cornerRadius: containerRadius.topRight.x),
      bottomLeft:
          BaconSquircleRadius(cornerRadius: containerRadius.bottomLeft.x),
      bottomRight:
          BaconSquircleRadius(cornerRadius: containerRadius.bottomRight.x),
    );
    ...
    void drawBar(double x, double width) {
      ...
      final progressRect = RRect.fromRectAndCorners(
        ...
        topLeft: BaconSquircleRadius(cornerRadius: progressRadius.topLeft.x),
        topRight: BaconSquircleRadius(cornerRadius: progressRadius.topRight.x),
        bottomLeft:
            BaconSquircleRadius(cornerRadius: progressRadius.bottomLeft.x),
        bottomRight:
            BaconSquircleRadius(cornerRadius: progressRadius.bottomRight.x),
      );
  ...
  @override
  bool shouldRepaint(BaconLinearProgressIndicatorPainter oldPainter) {
